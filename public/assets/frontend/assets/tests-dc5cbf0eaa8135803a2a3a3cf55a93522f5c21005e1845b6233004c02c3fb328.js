...
define('frontend/tests/components/bottom-modal.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - components');
  QUnit.test('components/bottom-modal.js should pass jshint', function (assert) {
    assert.ok(true, 'components/bottom-modal.js should pass jshint.');
  });
});
define('frontend/tests/controllers/application.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('controllers/application.js should pass jshint', function (assert) {
    assert.ok(false, 'controllers/application.js should pass jshint.\ncontrollers/application.js: line 5, col 5, \'$\' is not defined.\ncontrollers/application.js: line 6, col 12, \'Spree\' is not defined.\ncontrollers/application.js: line 8, col 16, \'$\' is not defined.\n\n3 errors');
  });
});
define('frontend/tests/controllers/index.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('controllers/index.js should pass jshint', function (assert) {
    assert.ok(false, 'controllers/index.js should pass jshint.\ncontrollers/index.js: line 14, col 16, Missing semicolon.\ncontrollers/index.js: line 13, col 13, \'$\' is not defined.\n\n2 errors');
  });
});
define('frontend/tests/controllers/onetime.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - controllers');
  QUnit.test('controllers/onetime.js should pass jshint', function (assert) {
    assert.ok(true, 'controllers/onetime.js should pass jshint.');
  });
});
...
define('frontend/tests/integration/components/bottom-modal-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleForComponent)('bottom-modal', 'Integration | Component | bottom modal', {
    integration: true
  });
  ...
  (0, _emberQunit.test)('it renders', function (assert) {
    ...
    this.render(Ember.HTMLBars.template((function () {
      return {
        ...
        statements: [['content', 'bottom-modal', ['loc', [null, [1, 0], [1, 16]]]]],
        locals: [],
        templates: []
      };
    })()));
    ...
    this.render(Ember.HTMLBars.template((function () {
      ...
      return {
        ...
        statements: [['block', 'bottom-modal', [], [], 0, null, ['loc', [null, [2, 4], [4, 21]]]]],
        locals: [],
        templates: [child0]
      };
    })()));
...
define('frontend/tests/integration/components/bottom-modal-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - integration/components');
  QUnit.test('integration/components/bottom-modal-test.js should pass jshint', function (assert) {
    assert.ok(true, 'integration/components/bottom-modal-test.js should pass jshint.');
  });
});
...
/* jshint ignore:end */
//# sourceMappingURL=http://jolart.com/assets/frontend/assets/tests.map
