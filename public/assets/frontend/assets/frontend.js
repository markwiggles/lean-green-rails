  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      meta: {
        ...
        "moduleName": "frontend/templates/about.hbs"
      },
      arity: 0,
      cachedFragment: null,
      hasRendered: false,
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        var el0 = dom.createDocumentFragment();
        var el1 = dom.createElement("h2");
        var el2 = dom.createTextNode("Index here now");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        return el0;
      },
...
define('frontend/config/environment', ['ember'], function(Ember) {
  return { 'default': {"modulePrefix":"frontend","environment":"development","baseURL":"/frontend","locationType":"auto","EmberENV":{"FEATURES":{}},"APP":{"name":"frontend","version":"0.0.0+09ed13e2"},"contentSecurityPolicyHeader":"Content-Security-Policy-Report-Only","contentSecurityPolicy":{"default-src":"'none'","script-src":"'self' 'unsafe-eval'","font-src":"'self'","connect-src":"'self'","img-src":"'self'","style-src":"'self'","media-src":"'self'"},"exportApplicationGlobal":true}};
});

if (!runningTests) {
  require("frontend/app")["default"].create({"name":"frontend","version":"0.0.0+09ed13e2"});
}

/* jshint ignore:end */
//# sourceMappingURL=https://localhost:3000/frontend/development/assets/frontend/assets/frontend.map
